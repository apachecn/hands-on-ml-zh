...
![life_satisfaction = \theta _{0} + \theta _{1} * GDP_per_capita](../images/tex-5471cac883ad5dad10d1cc1d7348aafb.gif)
...
![MSE (\mathbf{X},h _{\theta}![) = ](../images/tex-5d022250e1ef8945ce55d4aad010e47e.gif)\frac{1}{m} \sum\limits_{i=1}^m{\left(\theta^T \cdot \mathbf{x}^{(i)}-y^{(i)}\right)}^2](../images/tex-c7b8cd5182d4ad792dec80ff4ef5b3a7.gif)
