...
![](/Users/qusong/Desktop/cnn翻译/hands_on_Ml_with_Sklearn_and_TF/images/chapter_9/9-1.png)
...
![](/Users/qusong/Desktop/cnn翻译/hands_on_Ml_with_Sklearn_and_TF/images/chapter_9/9-2.png)
...
- 最后，它拥有一支充满热情和乐于助人的开发团队，以及一个不断成长的社区，致力于改善它。它是GitHub上最受欢迎的开源项目之一，并且越来越多的优秀项目正在构建之上（例如，查看https://www.tensorflow.org/ 或 https://github.com/jtoy/awesome-tensorflow）。要问技术问题，您应该使用http://stackoverflow.com/并用“**tensorflow**”标记您的问题。您可以通过GitHub提交错误和功能请求。有关一般讨论，请加入**Google小组**。

   ![](/Users/qusong/Desktop/cnn翻译/hands_on_Ml_with_Sklearn_and_TF/images/chapter_9/Tbale 9-1.png)
