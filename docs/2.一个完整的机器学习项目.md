...
![图2-9 收入分类的柱状图](https://upload-images.jianshu.io/upload_images/7178691-6f5f192c61bd9806.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图2-10 分层采样和纯随机采样的样本偏差比较](https://upload-images.jianshu.io/upload_images/7178691-6aaaf5a4dfe511a5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
因为存在地理信息（纬度和经度），创建一个所有分区的散点图来数据可视化是一个不错的注意（图2-11）：
```python
housing.plot(kind="scatter", x="longitude", y="latitude")
```

![图2-11 数据的地理信息散点图](https://upload-images.jianshu.io/upload_images/7178691-90fa1be435569d25.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图2-12 显示高密度区域的散点图](https://upload-images.jianshu.io/upload_images/7178691-cb9bec05a3d2ddca.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图2-13 加州房价](https://upload-images.jianshu.io/upload_images/7178691-017573305488b4da.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
